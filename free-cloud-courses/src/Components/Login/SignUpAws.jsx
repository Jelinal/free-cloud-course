    ...
    <div className="flex items-center justify-center min-h-screen bg-blue-100">
      ...
      >
        ...
        <p className="mt-4 text-sm text-center">
          Do you have an account? <Link to='/loginaws' className="w-full bg-yellow-600 text-black font-bold px-4 py-2 rounded-md hover:bg-yellow-700 transition">Login</Link>
        </p>
      </form>
    </div>
    // <Footer/>
